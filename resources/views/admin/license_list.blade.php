                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    @foreach ($license as $liceseItem)
                                        <?php $ipDetails = json_decode($liceseItem->ip_details); ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">
                                                            @if ($liceseItem->name)<span>Name</span>: {{ $liceseItem->name }} @endif
                                                        </a>
                                                        <a href="#" class="text-muted text-hover-primary fw-bold text-muted d-block fs-7"><span class="text-dark">Email</span>:{{ $liceseItem->email }}</a>
                                                    </div>
                                                    <!--end::Name-->
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ $liceseItem->website_url }}" target="_blank"
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('license.delete', $liceseItem->id) }}"
